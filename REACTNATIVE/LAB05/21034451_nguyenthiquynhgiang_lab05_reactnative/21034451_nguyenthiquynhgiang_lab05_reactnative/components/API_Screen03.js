...
const API_Screen03 = () => {
  const [job, setJob] = useState('');  //luu cong viec
  const route = useRoute();  // lay router nhan gtri dc truyen qua tu screen01
  const { userName } = route.params;  // nhan gtri username tu Screen01
  ...
  return(
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        ...
        style={styles.button}
        onPress={() => {
            // Quay lại màn hình API_Screen02
