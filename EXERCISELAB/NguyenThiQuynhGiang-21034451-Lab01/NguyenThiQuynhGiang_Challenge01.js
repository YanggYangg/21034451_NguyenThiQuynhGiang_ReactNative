...
if(markHigherBMI_data1){
    console.log(`Mark's BMI (${BMIofMark_1}) is higher than John's (${BMIofJohn_1})!`);
} else {
    console.log(`John's BMI (${BMIofJohn_1}) is higher than Mark's (${BMIofMark_1})!`);
}
...
if(markHigherBMI_data2){
    console.log(`Mark's BMI (${BMIofMark_2}) is higher than John's (${BMIofJohn_2})!`);
} else {
    console.log(`John's BMI (${BMIofJohn_2}) is higher than Mark's (${BMIofMark_2})!`);
}
